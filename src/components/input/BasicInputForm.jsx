  ...
  return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 relative">
        ...
        <AdvancedOptions
            ...
            setSpaceProportionally={setSpaceProportionally}
            vertical={vertical}
            setVertical={setVertical}
            allowBothSides={allowBothSides}
            setAllowBothSides={setAllowBothSides}
        />
        <form
            ref={formRef}
            ...
            style={{ maxHeight: showForm ? `${formRef.current?.scrollHeight}px` : '0', opacity: showForm ? 1 : 0 }}
        >
